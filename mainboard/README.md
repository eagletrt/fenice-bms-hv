...
|-- MCU.sch                 # MCU schematic
|-- HVSide.sch              # High voltage monitoring schematic
...
|   |-- bom/                # BOM folder
|-- CUBEMIX_CONFIG          # Don't know
|-- related_projects/       # Don't know
|-- dont_delete_me_yet/     # Don't know
|-- marked_as_bak/          # Gonna be deleted
```
